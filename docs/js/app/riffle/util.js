...
var specials_16979 = new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, ["-","[","]","{","}","(",")","*","+","?",".","\\","^","$","|"], null);
var escapes_16980 = cljs.core.zipmap(specials_16979,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (specials_16979){
return (function (p1__16978_SHARP_){
return [cljs.core.str("\\"),cljs.core.str(p1__16978_SHARP_)].join('');
});})(specials_16979))
,specials_16979));
/**
 * Escapes regex special chars in the string `s`.
 */
riffle.util.regex_escape = ((function (specials_16979,escapes_16980){
return (function riffle$util$regex_escape(s){
return clojure.string.escape(s,escapes_16980);
});})(specials_16979,escapes_16980))
;
/**
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__16981_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__16981_SHARP_),idx);
